package com.arreme.mtt3.domain.containers;


import com.arreme.mtt3.domain.tileentities.ExampleChestTileEntity;
import com.arreme.mtt3.register.inits.BlockInit;
...
public class ExampleChestContainer extends Container {
    ...
    public ExampleChestContainer(final int windowId, final PlayerInventory playerInventory, final ExampleChestTileEntity tileEntity) {
        super(ContainerInit.EXAMPLE_CHEST.get(), windowId);
        this.tileEntity = tileEntity;
        posCallable = IWorldPosCallable.of(tileEntity.getWorld(),tileEntity.getPos());
        // Main Inventory
        int startX = 8;
        int startY = 18;
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(posCallable, playerIn, BlockInit.EXAMPLE_CHEST.get());
    }
