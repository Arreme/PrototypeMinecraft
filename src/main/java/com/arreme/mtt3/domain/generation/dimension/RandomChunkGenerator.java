...
public class RandomChunkGenerator extends NoiseChunkGenerator<ExampleGenSettings> {
    ...
    public RandomChunkGenerator(IWorld worldIn, BiomeProvider provider, ExampleGenSettings settingsIn) {
